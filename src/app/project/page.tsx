  ...
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        {/* Responsive Layout */}
        <div className="grid gap-10 lg:grid-cols-12 items-start my-16">
          ...
          <div className="text-center mx-auto lg:col-span-5 col-span-12">
            <img
              ...
              className="w-110 h-80 rounded-4xl border-4 border-white object-cover mx-auto"
            />
          </div>

          {/* Text Content - 8 columns on lg */}
          <div className="lg:col-span-7 col-span-12">
            <h3 className="text-2xl font-bold mb-2">Toko Online</h3>
            <a
        ...
        <div className="grid gap-10 lg:grid-cols-12 items-start my-16">
          {/* Text Content - 8 columns on lg */}
          <div className="lg:col-span-7 col-span-12">
            <h3 className="text-2xl font-bold mb-2">Next Blog</h3>
            <a
              href="https://higesan.store"
              target="_blank"
              rel="noopener noreferrer"
